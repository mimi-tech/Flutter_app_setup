...
const _fontColor = AppColors.blackColor;
...
const TextTheme appTextTheme = TextTheme(
  ...
  headlineMedium:
      TextStyle(fontSize: 34.0, fontWeight: FontWeight.w600, color: _fontColor),
  // Smaller titles
  headlineSmall:
  ...
  titleSmall:
      TextStyle(fontSize: 14.0, fontWeight: FontWeight.w600, color: _fontColor),
  // Large body text
  bodyLarge:
      TextStyle(fontSize: 16.0, fontWeight: FontWeight.w600, color: _fontColor),
  // Default body text
